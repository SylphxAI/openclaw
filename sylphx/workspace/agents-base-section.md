<!-- BEGIN MANAGED BLOCK -->
## Infra Conventions
- Set up your own memory consolidation cron job (review + consolidate memory files every few days).
- Record more rather than less — you can always consolidate later.
